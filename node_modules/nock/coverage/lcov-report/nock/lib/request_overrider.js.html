...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">91.27% <small>(230 / 252)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">87.43% <small>(146 / 167)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">92.86% <small>(26 / 28)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">91.97% <small>(229 / 249)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">444</span>
<span class="cline-any cline-yes">3630</span>
<span class="cline-any cline-yes">3630</span>
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (continued) {
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      continued = true;
&nbsp;
...
&nbsp;
      ...
      response.socket = _.extend(response.socket || <span class="branch-1 cbranch-no" title="branch not covered" >{},</span> {
        authorized: true
      });
&nbsp;
